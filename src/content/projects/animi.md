...
screens:
  ...
  - src: ../../assets/projects/animi/main.png
    alt: Animi home screen with story templates
  - src: ../../assets/projects/animi/library.png
    alt: Animi template library
  - src: ../../assets/projects/animi/market.png
    alt: Animi template market
  - src: ../../assets/projects/animi/editor.png
    alt: Animi story editor
  - src: ../../assets/projects/animi/editor-text.png
    alt: Animi editor with animated text
  - src: ../../assets/projects/animi/text-editing.png
    alt: Animi text editing controls
  - src: ../../assets/projects/animi/music.png
    alt: Animi music picker
  - src: ../../assets/projects/animi/timeline.png
    alt: Animi timeline with clips
  ...
  - title: Prototype & testing
    ...
    screens:
      ...
      - src: ../../assets/projects/animi/onboarding-2.png
        alt: Animi onboarding, second step
      - src: ../../assets/projects/animi/onboarding-3.png
        alt: Animi onboarding, third step
      - src: ../../assets/projects/animi/main.png
        alt: Animi home screen with story templates
      - src: ../../assets/projects/animi/library.png
        alt: Animi template library
  ...
  - title: Design
    ...
    screens:
      ...
      - src: ../../assets/projects/animi/filled-template.png
        alt: Animi template filled with user footage
      - src: ../../assets/projects/animi/editor.png
        alt: Animi story editor
      - src: ../../assets/projects/animi/editor-text.png
        alt: Animi editor with animated text
      - src: ../../assets/projects/animi/text-editing.png
        alt: Animi text editing controls
      - src: ../../assets/projects/animi/text-editing-2.png
        alt: Animi text style and animation picker
      - src: ../../assets/projects/animi/reel-editor.png
        alt: Animi reel editor
      - src: ../../assets/projects/animi/timeline.png
        alt: Animi timeline with clips
      - src: ../../assets/projects/animi/music.png
        alt: Animi music picker
      - src: ../../assets/projects/animi/preview.png
        alt: Animi preview before export
      - src: ../../assets/projects/animi/export.png
        alt: Animi export screen
